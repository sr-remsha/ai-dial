...
Quick app is one of the [application types](/docs/platform/3.core/7.apps.md#application-types) in DIAL. You can create instances of Quick apps using DIAL API and UI wizards.
  ...
  "mcp_toolset": [
    {
      ...
      "allowed_tools": ["invert_string", "sum_integers", "get_small_picture"]
    }
  ]
}
```
...
```json
{
  ...
  "applicationProperties": {
    ...
    "model": "gpt-4o-2024-05-13",
    "starters": ["What to wear in London", "What is the weather in Paris"],
    "applications_as_tools": [
      {
        "conditions": [
          {
